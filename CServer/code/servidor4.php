...
$req = $bdd->query('SELECT id, temp, fecha FROM temperaturas where id_sensor=10');
//Initiar una tabla
$resultat1=array();
$j=1;
...
$req= $bdd->query('SELECT id, temp, fecha FROM temperaturas where id_sensor=11');
...
$req= $bdd->query('SELECT id, temp, fecha FROM temperaturas where id_sensor=12');
//on crée un tableau
$resultat3=array();
$j=1;
while ($donnees = $req->fetch())
