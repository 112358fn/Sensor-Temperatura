...
\begin{figure}[H] % Example of including images
\begin{center}
\includegraphics[width=0.5\linewidth]{lm35sch}
\end{center}
...
%---------------------------------------------------------------------
\labday{Viernes 5, Septiembre 2014}
\experiment{Diseño del PCB para el sensor LM35}
...
\begin{figure}[H] % Example of including images
  \begin{center}
    \includegraphics[angle=-90]{lm35brd} 
  \end{center}
